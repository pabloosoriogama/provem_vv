...
class HrEmployee(models.Model):
    ...
    hcalle = fields.Char(string='Calle')
    hnext = fields.Char(string='N° Ext.')
    hnint = fields.Char(string='N° Int.')
    hcolonia = fields.Char(string='Colonia')
    hciudad = fields.Char(string='Ciudad')
    hestado = fields.Char(string='Estado')
    hcp = fields.Char(string='C.P.')
